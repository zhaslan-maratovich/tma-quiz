 ...
 */
export async function createAnswer(questionId: string, data: CreateAnswerInput): Promise<Answer> {
 ...
 * Обновить ответ
 */
export async function updateAnswer(id: string, data: UpdateAnswerInput): Promise<Answer> {

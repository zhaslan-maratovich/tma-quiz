 ...
 */
export async function createResult(testId: string, data: CreateResultInput): Promise<TestResult> {
 ...
 * Обновить результат
 */
export async function updateResult(id: string, data: UpdateResultInput): Promise<TestResult> {

/**
 * ResultPage View - презентационный компонент
 */

import { motion } from 'framer-motion';
import { Trophy, Share2, RotateCcw, Home, CheckCircle, XCircle, Sparkles } from 'lucide-react';
...
import type { ResultPageViewProps } from './ResultPage.types';
        ...
        return (
            <PageContainer>
                <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                    ...
                    <Button onClick={onGoToTest}>Пройти тест</Button>
                </div>
            </PageContainer>
        );
    }
    ...
    return (
        <PageContainer gradient noPadding>
            <div className="flex flex-col min-h-screen">
                        ...
                        {isQuiz ? (
                            ...
                            <>
                                ...
                                {session.result?.description && (
                                    <p className="text-tg-hint">{session.result.description}</p>
                                )}
                            </>
                        )}
                    </motion.div>
                ...
                >
                    <Button variant="gradient" size="lg" fullWidth onClick={onShare}>

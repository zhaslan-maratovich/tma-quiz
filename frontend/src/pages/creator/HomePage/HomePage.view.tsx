/**
 * HomePage View - презентационный компонент
 */
    ...
    return (
        <PageContainer
            ...
            header={
                <Header
                    rightAction={
                        <Button variant="gradient" size="sm" onClick={onCreateTest}>
        ...
        >
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <h1 className="text-2xl font-bold text-tg-text mb-1">{greeting}</h1>
                <p className="text-tg-hint">Создавайте тесты и делитесь ими с аудиторией</p>
            </motion.div>
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <h3 className="font-semibold text-white mb-0.5">Создать новый тест</h3>
                        <p className="text-sm text-white/80">Викторина, тест личности или сюжет</p>
                    </div>
            ...
            {/* Tests section */}
            <div>
                <h2 className="text-lg font-semibold text-tg-text mb-4">Мои тесты</h2>
